...
public class Input {
    ...
    private int flexibilityParameter = 18;                      //Load in Xpress can be load from heuristic 2 +- flexibilityParameter
...
*/
    ...
    public int getFlexibilityParameter() {
        return flexibilityParameter;
    }

    public void setFlexibilityParameter(int flexibilityParameter) {
        this.flexibilityParameter = flexibilityParameter;
    }
