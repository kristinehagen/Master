        ...
        for (int instance = 1; instance <= 4; instance++) {
            ...
            for (int t = 7; t<=17; t+=10) {
                ...
                for (double weightTimeToViolation = 0; weightTimeToViolation <= 1; weightTimeToViolation += 0.10) {
                    ...
                    for (double vioRate = 0; vioRate <= 1 - weightTimeToViolation; vioRate += 0.10) {
                        input.setWeightCritScViolationRate(vioRate);
                        for (double weightDT = 0; weightDT <= 1 - weightTimeToViolation - vioRate; weightDT += 0.10) {
                            input.setWeightCritScDrivingTime(weightDT);
                            input.setWeightCritScOptimalState(1 - weightTimeToViolation - weightDT - vioRate);
